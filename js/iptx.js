...
$.ajax({
    ...
    data: {
        key: '5CPBZ-542L4-5JMUM-KB3HJ-R53MO-XGBNG',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(34.72468,113.6401,ipLoacation.result.location.lng,ipLoacation.result.location.lat); //这里记录你自己的经纬度
